...
* `distro`: Linux distribution name: `ubuntu16.04`, `ubuntu18.04`, `ubuntu20.04`, `bullseye`, `buster`, `stretch`, `jessie`, `fedora_latest`, `alpine_latest`, `archarm_latest`, `openeuler_latest`, `openeuler20.03` or `openeuler22.03`. See [Supported Platforms](#supported-platforms) for the full matrix.
...
| aarch64  | stretch, buster, bullseye, ubuntu16.04, ubuntu18.04, ubuntu20.04, ubuntu22.04, ubuntu_latest, ubuntu_rolling, ubuntu_devel, fedora_latest, alpine_latest, archarm_latest, openeuler_latest, openeuler20.03, openeuler22.03 |
